class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {}</b>
<b>Sᴏʀʀʏ ɪ ᴏɴʟʏ ᴡᴏʀᴋ ᴏɴ</b> <b><a href=https://t.me/CinimaLokham>ᴄɪɴᴇᴍᴀ ᴍᴇᴅɪᴀ</a></b><b> Gʀᴏᴜᴘ. Nᴏ ᴏᴛʜᴇʀ ᴄᴏᴍᴍᴀɴᴅ ᴡɪʟʟ ᴡᴏʀᴋ ᴏɴ ᴛʜɪs ʙᴏᴛ ᴇxᴄᴇᴘᴛ sᴛᴀʀᴛ. ᴅᴏɴ’ᴛ ᴡᴀsᴛᴇ ʏᴏᴜʀ ᴛɪᴍᴇ</b>"""
    OWNER_TXT = """<b>⍟───[ ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ ]───⍟
    
• ꜰᴜʟʟ ɴᴀᴍᴇ : ᴜɴᴋɴᴏᴡɴ ᠰ ᴛɢ
• ᴜꜱᴇʀɴᴀᴍᴇ : @CM00PRO
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href=https://t.me/@CM00PRO>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
    HELP_TXT = """𝙷𝙴𝚈 {}
...
<code>[Button Text](buttonalert:This is an alert message)</code>"""
    AUTOFILTER_TXT = """<b>🤖 ʙᴏᴛ ɴᴀᴍᴇ: Bʜᴀsɪ 
