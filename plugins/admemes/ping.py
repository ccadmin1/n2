...
async def ping(_, message):
    ...
    uptime = time.strftime("%Hh | %Mm | %Ss", time.gmtime(time.time() - BOT_START_TIME))
    await message.send_sticker(chat_id=message.chat_id, "CAACAgUAAxkBAAFMES9i7nknE3lSO20KTf9j5Zu1U9lRJwACvQMAAg472FWXnTfo27wNfR4E")
    await message.edit(f"🏓 <b>ᴘɪɴɢ</b> : <code>{time_taken_s:.3f} ms</code>\n\n⏰<b> ᴜᴘᴛɪᴍᴇ : </b><code>{uptime}</code>")
